        ...
        <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          ...
          <div className="bg-white/80 backdrop-blur-lg border border-primary/15 rounded-3xl p-12 mb-12 shadow-2xl">
            ...
            <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mb-8">
              <Link href="https://calendly.com/inna-ntp/free-restart-discovery-call" className="group bg-primary text-white px-12 py-5 rounded-2xl font-bold text-xl transition-all duration-300 hover:bg-primary/90 hover:scale-105 shadow-2xl hover:shadow-primary/25">
