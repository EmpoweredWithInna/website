...
export function FinalCTA() {
  ...
  return (
    <section 
      id="final-cta"
      className="relative py-24 bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 text-white overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="inline-flex items-center bg-green-700/20 border border-green-600/30 text-emerald-300 px-6 py-3 rounded-full text-sm font-semibold mb-8">
          ...
          <h2 className="text-5xl lg:text-6xl font-bold mb-8 leading-tight">
            Ready to 
            <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent"> Transform</span>
            <br />Your Health?
          </h2>
        ...
        <div className={`transition-all duration-1000 delay-500 ${
          ...
          <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-12 mb-12">
            ...
            <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mb-8">
              <button className="group bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-12 py-5 rounded-2xl font-bold text-xl transition-all duration-300 hover:from-emerald-400 hover:to-teal-400 hover:scale-105 shadow-2xl hover:shadow-emerald-500/25">
        ...
        <div className={`transition-all duration-1000 delay-700 ${
          ...
          <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-400/30 rounded-3xl p-8 mb-12">
            <div className="text-center">
              <div className="flex items-center justify-center mb-6">
                <div className="w-16 h-16 bg-orange-500/30 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-8 h-8 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <div>
                  <h4 className="text-2xl font-bold text-orange-200">Limited Availability</h4>
                  <p className="text-orange-300">Only 10 new clients accepted monthly</p>
                </div>
              </div>
        ...
        <div className={`text-center transition-all duration-1000 delay-900 ${
          ...
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-8 py-6">
            <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center mr-6">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <div className="text-left">
              <div className="font-bold text-xl mb-1">100% Satisfaction Guarantee</div>
              <div className="opacity-75">Risk-free discovery call • No pressure • No obligation</div>
            </div>
          </div>
        </div>
      </div>
