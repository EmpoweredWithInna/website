...
export function Testimonials() {
  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-slate-50 via-white to-emerald-50/20 overflow-hidden" id="testimonials">
      {/* Background Elements */}
      <div className="absolute top-0 left-1/3 w-96 h-96 bg-gradient-to-br from-emerald-100/30 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-gradient-to-tl from-teal-100/20 to-transparent rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Real Women, <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Real Results</span>
          </h2>
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 lg:p-12 mb-12 border border-gray-100/50">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              {/* Client Info & Quote */}
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 to-teal-400 rounded-full flex items-center justify-center text-white font-bold text-xl">
                ...
                <div className="relative mb-6">
                  <svg className="w-8 h-8 text-emerald-200 absolute -top-2 -left-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-emerald-800">After</span>
                    </div>
                    <p className="text-emerald-700 text-sm">{testimonials[activeTestimonial].beforeAfter.after}</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100/50 group hover:-translate-y-1">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-3xl p-12 text-white shadow-2xl">
            ...
            <button className="group bg-white text-emerald-600 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:bg-gray-50 hover:scale-105 shadow-xl hover:shadow-2xl">
