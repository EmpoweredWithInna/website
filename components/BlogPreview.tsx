...
export function BlogPreview() {
  ...
  const blogPosts = [
    ...
    {
      title: "HTMA Testing: What Your Hair Reveals About Your Health",
      excerpt: "Learn how Hair Tissue Mineral Analysis can uncover mineral imbalances and heavy metal toxicity that standard blood tests miss.",
      date: "March 8, 2024", 
      readTime: "12 min read",
      category: "Testing",
      tags: ["HTMA", "Mineral Testing", "Heavy Metals"],
      featured: false,
      slug: "htma-testing-guide",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-slate-50 via-white to-emerald-50/10 overflow-hidden" id="blog">
      {/* Background Elements */}
      <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-bl from-emerald-100/20 to-transparent rounded-full blur-3xl"></div>
      <div className="absolute bottom-1/4 left-0 w-80 h-80 bg-gradient-to-tr from-teal-100/30 to-transparent rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Health <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Knowledge Hub</span>
          </h2>
        ...
        {featuredPost && selectedCategory === "All" && (
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} mb-16`}>
            <div className="bg-gradient-to-br from-emerald-500 to-teal-500 rounded-3xl p-8 lg:p-12 text-white shadow-2xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <button className="bg-white text-emerald-600 px-8 py-4 rounded-2xl font-semibold transition-all duration-300 hover:bg-gray-50 hover:scale-105 shadow-xl">
                    Read Full Article
                  </button>
                </div>
          ...
          {regularPosts.slice(0, 6).map((post, index) => (
            ...
            >
              ...
              <div className="p-6 pb-4">
                ...
                <button className="inline-flex items-center text-emerald-600 font-semibold hover:text-emerald-700 transition-colors duration-300 group">
                  Read Article
        ...
        <div className="text-center">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-xl border border-gray-100/50">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-green-700 to-emerald-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:from-green-600 hover:to-emerald-600 hover:scale-105 shadow-xl hover:shadow-2xl">
                Visit Our Blog
              </button>
              <button className="border-2 border-green-700 text-green-700 px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:bg-green-700 hover:text-white hover:scale-105">
